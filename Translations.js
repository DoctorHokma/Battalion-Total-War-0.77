ENG={
	...
	UnitNames:["null",
		...
		"Cockroach Tank","Bolt Tank","Asekara Tank","Gorlitz Tank","Tank-Hunter","AMPAC","Koschei Tank","Imperterritus Tank","Entwicklung Pantser","GBC Roland MkIII",
		"Howitzer Battery","AA Artillery","Anti-Tank Artillery","Moldan Battery","SPAB","Rocket Tank","Big Bertha Battery","Pula SRBMDP","Tugarin ATMB","Brimstone Battery",
		"Stork Transport","Pelican Transport","Raptor Fighter","Eagle Striker","Condor Bomber","Akontio Torpedor","Zeus Stormlord","Solovey Superbomber","AVN-1 Stihie","ALEPH",
	...
	UnitDesc:[
		...
		"Lightly equipped and almost untrained, these men aren't the best for combat, but they're easy to pump out.",
		"The backbone of every army. Reliable, durable and most importantly, cheap.",
		"Well trained, well equipped and ready for your command",
		"Raised in the harsh taigas of Transkal, these men had to hunt to survive. Very good in rugged terrain.",
		"Trained to attack and overrun beaches or rivers quickly. Capable of fighting on water as on land.",
		"Well-trained veterans of the Akkadian War and well equipped with long-range weapons.",
		"These men are trained to infiltrate enemy lines and sabotage their infrastructure.",
		"Having endured the most brutal training and education, they are ready to die for the nation.",
		"These men literally throw lives away to thwart heavy tanks. Desperate, but efficient",
		"The best of the best white guards become paladins, supersoldiers with terrific skill, courage and weaponry",

		"Millenia have not yet seen the humble horseman be out of a role in warfare",
		"Much faster than normal infantrymen, they are good if you want to occupy a lot of structures quickly.",
		"As if anyone had a doubt logistics win wars, this little fella is deceptively terrifying in the hands of a competent commander",
		"Adapted to prevent enemy air supremacy, the Flak Tank shreds through aircraft.",
		"The Crab cannot be stopped even by water. It can just as well fight in both environments",
		"This wonderweapon will subject masses of enemy infantry to HORRIBLE suffering.",
		"A marvel of engineering, can fully produce other units on the go",
		"A vehicle ultraspecialized in crossing difficult terrain and harsh conditions. Can perform admirably just about anywhere",
		"Overcompensating for the lack of competent ground forces with a supremely versatile close air support machine",
		"Forbidden technology; it shoots a neutron flux frontwards, irradiating scores of enemies. Its use will likely only be lawful for a decade or so.",

		"An annoying little bugger that can be mass-produced to piss off the enemy for good",
		"Fast but fragile, this unit is good for blitz attacks",
		"Standardized, easy to produce and easy to deploy, the Asekara Tank is the most cost-effective armored vehicle.",
		"The Gorlitz Tank is powerful but plagued with inadequacies. ",
		"Cleverly designed to destroy enemy tanks effectively, and be hard to destroy in return.",
		"Incapable of making big tanks, Elam has considered to specialize them for action in rugged terrain.",
		"The pinnacle of Kargit engineering and Blitzkrieg doctrine, a wehrb's wet dream.",
		"The Imperterritus is as terrifying to face as it is invulnerable to most weapons.",
		"Improving upon the Koschei's advantages and compensating its shortcomings; the ultimate main battle tank",
		"Combining Imperterritus's toughness and Koschei's speed to produce the ultimate battle tank",
		
		"So long as the frontline holds, artillery will be the king of warfare.",
		"Designed with versatility in mind, that it may be compatible with both AA and HE shells.",
		"Armour-piercing artillery designed to wreck tanks",
		"The terror of infantry everywhere, and can also dodge counter-battery fire.",
		"Expensive piece of military hardware. Although on paper impressive, it is only feasible in several situations",
		"Back in that crazy era, the astartian nations were experimenting strapping missiles to any vehicle type they could",
		"Yepee-ka-yeh, motherfucker!",
		"No better way to prove your superiority than by having the bigger dick. These giant flying dildos, for example",
		"Specialized system that utilizes ballistic missiles to terrorize tanks and planes alike",
		"Cutting edge thermobaric artillery capable of unleashing literal fire and brimstone upon the enemy",
		
		"Actually remarkable piece of engineering, capable of transporting some units via air",
		"We have one job. Fly in fresh boys; and fly out wounded men",
		"Fast and furious, specialized in hunting other enemy planes.",
		"Made with the specific purpose of trolling land units.",
		"For when you feel that the Eagle Striker doesn't carry enough dakka",
		"According to the principle of cavitation, this plane fucks ships harder than Azur Lane players would.",
		"Avant-garde technology, achieves much superior dogfighting and bombing results than any other plane.",
		"A heavy, sluggish bomber with massive payload. Devastating against infrastructure and fortifications",
		"Innovative plane design that maintains a very low radar signature while gunning down any enemy aircraft with advanced weaponry",
		"The supreme weapon; as destructive as it is terrifying. Will forever change the face of warfare",

		"A barge designed with only one purpose in mind: To transport units",
		"Capable of capturing buildings, like shipyards and oil rigs. Mmmmm, oil...",
		"Contrary to popular belief, it does NOT deal extra damage to big ships.",
		"Cheap, reliable and versatile vessel.",
		"The true jack-of-all-trades. It can do about anything.",
		"Big guns, strong armor, but still reasonably affordable. Great for tormenting land units.",
		"Bigger guns, bigger armor, bigger hull, bigger range. Bigger everything. MORE DAKKA! BIGGER DAKKA!",
		"Carriers are the undisputed kings of the seas. Really expensive, but they'll blast any ship.",
		"Over 50.000 tons of steel for the ultimate dakka",
		"Supremely expensive steel monsters, but nearly undefeatable. One of these is enough to defeat an entire armada",

		"Cheap and easy to erect static fortifications capable of delaying enemy advance for a short while",
		"Concrete pillboxes with machineguns, ideal for deterring unchecked infantry advance",
		"Capable of striking at land, sea and air units, the Turret is by far the most versatile fortification class.",
		"A behemoth of thickened concrete and numerous anti-air cannons, it shreds through enemy aircraft.",
		"A battery of 400-mm artillery bores pointed at the sea. Will shatter enemy ships, but will not harm land or air units at all.",
		"A temporary industrial installation capable of generating funds for your war effort",
		"A missile box on top of a classic turret. Looks like a TV head dalek but is quite powerful. It can counter any land or air unit",
		"Static fortifications that will take the best of enemy bombardments and keep standing",
	...
	TraitName:[
		...
		"Uneven","Rugged","Precipitous","Impassable","Tricky Waters",
		"Concealment","Naval Concealment","Bunker",
		"Shallow","Vantage","Dangerous",
		"Logistic Challenge","Logistic Nightmare",
		"Financial Center","Fiscal Center","Fiduciary Center",
		"Conqueror","Skysweeper","Depth Charge","Sonar","Radar",
		"Anti-Infantry","Anti-Tank","Anti-Air","Anti-Ship","Anti-Structure",
		"Stealth","Submerged","Commando","Crab","Steer",
		"Indomitable","Schwerpunkt","Bewegungskrieg","Mobile Battery","Streamlined",
		"Cemented Steel Armor","Cavitation Explosion","Seabound","Self-Destruct","Dispersion","JUDGEMENT",
		"Supply Distribution","Inertial","Streamblast","Airborne","Heroic","Tank-Hunter",
		"Naval Transport","Air Transport","Unbuilt",
		"Tank Pooper","Absorber","Terrifying","Lynchpin","Inflaming"
	...
	TraitDesc:[
		"",
		"Vehicles will have slight difficulty crossing this","Harsh terrain, not easy to cross","High slopes and very difficult terrain","No unit can pass through","Ships will have a harder time navigating through",
		"Reduces damage taken by 20%","Reduces damage taken by 20%","Reduces damage taken by 40%",
		"Low-rudder ships must avoid these tiles or they will run aground","Ranged units here fire further because they have the higher ground.","Staying here damages your units 20HP per turn",
		"Fighting ability hampered by 20%","Fighting ability hampered by 40%",
		"Earns 100 credits per turn","Earns 200 credits per turn","Earns 300 credits per turn",
		"This unit can capture buildings","This unit can attack aircraft","This unit can attack submarines","This unit intercepts submerged units","This unit can spot stealth units",
		"Deals x3 damage against infantry","Cannot be counterattacked by tanks","Intercepts nearby aircraft","Deals 3x more damage against ships","Deals more damage to structures",
		"If this unit attacks while cloaked, it deals double damage","Cannot be attacked by most units","Deals more damage and recieves less in rugged terrain","Can cross rivers and is not defenseless in the process. But it's NOT a crab","Recieves less damage from slow units",
		"No retreat; no surrender!","Deals +40% damage to infantry if it attacks first","If it destroys a unit, it can attack again (only once per turn)","Cannot be counterattacked","Can be deployed further from the base",
		"Recieves less damage from Medium or Light weapons","Ignores Cemented Steel Armor trait","Can only attack sea units","After attacking, this unit self-destructs","Its attack hits in a 3x3 circle","YOU ARE FUCKED",
		"Its action replenishes the strength of allied units","This unit's survival does not prevent military defeat","Strikes all enemies in a direct line","Can board a transport plane and jump down behind enemy lines","This unit refuses to die and will survive with 1HP","Will attack first if engaged by a tank",
		"Not a very fast method of transporting units, but it will carry anything","The fastest transport, but can easily be shot down","This unit has not yet been constructed",
		"It poops tanks!","Recovers HP based on damage dealt","Its attacks devastate enemy Morale","Control of this is essential","Boosts Morale"

		],
	ClassTraitDesc:[
		"",
		"Recieves 50% more damage from Light weapons and 50% less from Heavy weapons","Recieves the same damage indifferent of the enemy's weapon type","Recieves 50% less damage from Light weapons and 50% more from Heavy weapons",
		"Deals 50% less damage to Heavy units, 50% more to Light units","Deals the same damage no matter the enemy's armor type","Deals 50% less damage to Light units, 50% more to Heavy units","This unit cannot attack",
	...
	ChapterName:[["Deluge","Comeback","Skewering the Effete","Strangling the Pathetic","Tide of Steel","Vengeance","Endgame"],
				...
				["Operation Incredible Liberation","Warplan Transkalite Freedom ","The Illusion Shatters","Earthquake in Xanadu","The Final Ultimatum"],
				["Unharness the War Horses!","Limping Forward","Dark Omen","Ruina Imperii","AL MALHAMA AL KUBRA"],
				...
				[]],
	MissionName:[
				[["Delay Action","Defend the Passes","Bitchslapping Polasians","Vladov's Last Stand","Operation INVINCIBLE"],
					["Operation Harpoon","Laszlo's Counterattack","Restricted Submarine Warfare","The Grand Offensive","Operation CELERITY"],
					["Steel Sharks","Fall of Valeria Island","Cassation","White Dusk","Operation SILVERSTEEL"],
					["Operation Țepeș","","","","Operation ICONOCLAST"],
					["","","","","Operation KATAPHRAKTOS"],
					["","","","","Operation GOTTDAMMERUNG"],
					["","","","","Operation TWINSTEEL"]],
				[["Operatsiya 'Leap'","Operatsiya 'Axe'","Operatsiya 'Anal Fisting'","The Great Pincer","The Siege of Patna"],
					["The Sack of Patna","Bela's Backing","Hands-on Boss","Wedge to Kaula","The Battle of Kaula"],
					["Operatsiya 'Trident'","The Rape of Kaula","Warplan 'Tugaryn'","Warplan 'Solovey'","Voyenyy Plan 'COLLOSSUS'"],
					[],
					[],
					[],
					[]],
				[["Our Backs Exposed","Our Enemies Bellicose","Our Name Scorned","Our Fame Shamed","Garde!"],
					["A Clash of Retards","Greasing Palms","Scrap vs Junk","And our song will be heard","All the way to Kaula and beyond"],
					["The Prince","Michael's Test Drive","The Reginal Camarilla","Alea Iacta Est","Coup d'Etat"],
					[],
					[]],
				[["Operation Surprise Buttsecks","Landfall","The Shield of Freedom","Ahh, Oil","Wrapping this up"],
					["Operation Cottage","Frozen 'Nam","What is a nazi? A miserable pile of racism and aggression","In the name of economic growth, consume!","For the people!"],
					["Blue sky, goodbye!","A strong woman would get the job done","Starving for Bread and Hope","Tet","And the soldiers will break ranks"],
					[],
					[]],
				[["Diversion","Storm the Passes","Ali's Great Offensive","Hassan's One-Two Punch","Guillotine"],
					["Chasing Smoke","Invasion of Jylla","The Vantage","Fall of Odenshagen","Freezing for nothing"],
					["Matters of Grace","Omen","Inglorious Withdrawal","Junk vs Scrap","Storm on the Horizon"],
					[],
					[]],
				[["","","","",""],["","","","",""]],
				[["","","","",""],["","","","",""]],
	...
	MissionDesc:[[],
		[//Somertin Federation
			...
			[//Chapter 2
				"Operation INVINCIBLE turned the tides and stopped the kargit warmachine in its tracks. Moreover, the splendid counterattack saw a hundred thousand men and the best 1000 kargit tanks, the proverbial tip of their lance, surrounded and cut off from the main army. Marshal Hryniuk will be given the honor of crushing the pocket once and for all. Meanwhile, on the southern front, Dumitrescu wants as much of Interriverana liberated as it's possible. Were they to advance, they would not only take pressure off of Anders's front but also allow Laszlo to take the fight to Elam later on",
				"With Laszlo secure and the Elamite advance petering out, High Command wants to stabilize the southern front once and for all. Supply flow to it has increased twofold and there are expectations for Marshal Laszlo to carry out a counteroffensive. Eager to get back at the Elamites, he jumps at the opportunity for a payback. Hopefully Shmelev of the Transkalites will share even a smidgeon of his enthusiasm...",
				"Although the Somertin battlefleet was largely grounded and torpedoed, they were in posession of a respectable submarine force. It cannot be allowed to stay idle. It will aid the northern front's efforts by sinking Polasian supply ships ",
		...
		[//Kargit Order State
			...
			"With Hans swiftly moving over the passes and into the northwestern part of Somertin, plans were being drafted for two times as many units to storm the bridges over the river Presus. Marshal Bela and Kulik will lead the charge, but the initial breakthrough is to be carried by Bela.",
			"The idiotic generals of the subhumans have left a gaping hole in their frontline. Hans and Kulik will cooperate towards a pincer offensive to encircle and neutralize an entire army worth 300.000 men. Doing so is of the utmost importance, as it will grant us local superiority in numbers",
			"The advance over the Mica, coupled with Esfahani's crossing of the Kandahar Mountains has left Laszlo and his Eight Army surrounded. Their force is too large to just be ignored, our advance must be swift but it must not let flanks exposed. For this, we'll ask the Elamites to liquidate the pocket like the good dogs they are, and we'll grant them air support.",
			"Hans's advance is the most crucial, since ahead of him lies the Somertin capital, Kaula. But before they can dream of taking that, they have to pass through the heavily-fortified city of Patna. Besting such a formidable fortress will not be an easy task even for the invincible Kargit Army."
				],
			[//Chapter 2
				"Time is precious for the Kargit forces. Doubly so for Marshal Hans who has to drive his armored spearhead into hopefully capturing Kaula, while his rear is unsecure. Patna had been enveloped, sure, but the rail-lines do not bypass it, and the city had not been captured fully either. Knowing that the spearhead must keep thrusting deeper, Khuzov wants Kulik to reinforce Hans's rear and secure his supply lines.",
				"Nothing is more complicated than crossing a defended river, and if the glorious suprahuman host wants to seize southern Somertin, they basically have to cross four rivers, each harder than the last. Usually, such operation would only be performed if it was secure to, but the Kargits do not have the luxury of picking fronts. They have to maintain constant pushes in order to not lose the strategic initiative. Bela will recieve commands to pick up Kulik's share and manage the southern front. While also advancing.",
				"While the southern front has advanced deep into Interriverana, it has not advanced broadly. Marshal Khuzov has long slept uneasy, fearing that while they divert the bulk of the supplies northwartds to try and take Kaula, the Whites may scheme a counterattack against the moronic Bela. Worse still, after Kulik finished his ordeal in Patna, he was struck by a bout of heart attack, so there is no way of knowing when is he returning. With few options, Khuzov decided to go and take personal command of Kulik's forces.",
				"Marhsal Khuzov's hands-on leadership had secured the integrity of Kargit control over western Interriverana, and Kulik had made an acceptable recovery from his condition. Things seem to be looking stable, if not great, for the Kargit host. Now, the great Marshal goes to oversee Hans's advance, and help him in the great battle that is coming.",
				"The Kargit army has advanced thousands of kilometers, and since Marshal Hans's last offensive the periphery of West Kaula is within sight. Taking the fortified citadel will be a herculean task, as the Kargit offensive is quickly approaching its Clausewitzian culmination. Khuzov has arranged for massive quantities of armor and materiel to be delivered to Hans's front, for what will be the toughest and most decisive offensive of the war. The Kargit Empire shall rise or fall, and that will be decided by the result of this very operation."
				],
			[//Chapter 3
				"It is done, the Somertins have commited their reserves to the citadel of Kaula. They had done so, assuming that the river flanks are secure enough to not be breached. A foolish assumption that will be their downfall",
				"Weber and Hoth's relentless assault; with Khuzov and Felix's support; Hans has managed to breach the flanks of Anders's front over Dambova, encircling Kaula and nearly 300.000 somertin men inside. It is time for a joint effort to break this pocket completely. With the fall of their capital, the morale of the white roaches will collapse and they will accept their masters.",
				"After the fall of their capital, Somertin's northwest front shows signs of frailty. KHC believes that they can engage in one all-out assault and that this one will cause their collapse. Meanwhile, news about Polasie's failures reach the ears of KHC but they don't particularly impress anyone.",
		...
		[//Transkal Commonwealth
			[//Chapter 1
			"A cowardly act by the Republic of Polasie, they landed dozens of battalions from the north and are trying to steal our tungsten mines. Lord Gustav is a very skilled commander but he has had no time to prepare. His disparate forces are making a fighting retreat, hoping to stall them enough.",
			"The North isn't the only problem, apparently. Concomitent amphibious landings from the Elamite Empire are taking place in General Krystof's domain. He might be...loyal... but he's not quite as skilled as Gustav. Let's just hope he can stall them sufficiently.",
			"Good news come from Jarvi, where General Vilho has assembled a division and sent it to Gustav's aid. Furthermore, the impetus of the polasians has dampened greatly. It's time they are stopped.",
			"The Queen has managed to convince General Shmelev to ride to Krystof's aid. Experienced and forged in past wars, he is likely to get the situation into control.",
			"It is most impressive how the Kargi mananged to use makeshift airfields to paradrop a team of SpecOps straight into the middle of our nation, next to the Reginal Citadel no less! The four generals must put aside their differences so that they can ensure the Queen's safety."
				],
			[//Chapter 2
			"Coincidence would have the Transkalite and Elamite moron generals pitted against eachother as Krystof's army is sent to reinforce the Shahar Front against Ali who had managed to push it back somewhat. Now or never, it will be proven which of them is more stupid!",
			"While Krystof secures his sector, someone else is needed for the Sassafras sector. And since deals in Transkal are done rather backhandedly, this requires the Queen to give some concessions...",
			"All too aware that her armies are away from home, and the (mainly coastal) polises exposed to a second naval landing, the Queen decides to waste no more time and secure naval supremacy. She is willing to risk everything; casting Gustav to lead what he's unused to, ships that will be overfueled and at great risk of explosion, operating at longer ranges than supposed to. Will her scrap navy defeat Elam's junk(but still stronger) navy?",
		...
		[//Polasie Democratic Republic
			...
			"With the somertin navy smashed the coast is clear for an amphibious landing, which is absolutely necessary. Arrangements for this are being made as we speak. A landing force is getting ready to make a dangerous trek across the sea.",
			"Over the horizon lies the river Moh and beyond it the oilfields we so dearly need. We need to push them back and cross the river.",
			...
			"From the north advanced the Polasians, and from the west the Kargits. Now there is a significant number of somertins trapped around Golubuju, with no way of getting supplied. The time has come to destroy Stoyan's veterans who humilliated us for so long."
				],
			[//Chapter 2
				"Although the Transkalite navy is nigh-useless, the Polasian high command wants it out of the picture, so that a future invasion may proceed unimpeded. Admiral Doris Miller, perhaps the most skilled of the Polasian Admirals, is practically the only one able to carry out this duty to the end.",
				"The special operation in Moh had worked wonderfully and the oilfields have been occupied by the brave Marines. Part of the Marine Corps, however, has been kept in standby for this occasion. Time to deploy them boys and take the tungsten-chromium mines of Svelge. Once the chromium and tungsten has been secured; the people will be able to enjoy TermoChroma® brand dildoes(which are all the rage these days). So let's go, let's do this for the dildoes of the people!",
				"Before the svelgian invasion force can venture further inland, their flank must be secured. For this, Pykot will lead a second marine force into Jarvian territory. Commander, you must beware! The Jarvians are fearless warriors unmatched in marksmanship and fiercely devoted to their independence. Even with firepower superiority, your victory will still require hard work.",
				"With local firepower superiority, Pykot's army has advanced steadily and is within recon distance of the much-desired tungsten mines. Once these are captured, the people of Polasie will be able to rejoice as these strategic resources will be used to make strategic goods.",
				"The Transkalite lack of forces in the region had been a temporary issue. The downside is it lured our forces to make unchecked advaces and salients. Now overextended, we realized General Gustav is likely to launch a devastating pincer assault if we do not intervene quickly"

				],
			[//Chapter 3
				"Polasie has made tenuous gains on the mainland, but now General Bernard is beginning to see dark omens as the White Army is gradually bringing more and more reinforcements. The Polasian Air Forces must hold on to parity against a rapidly expanding White Air Force",
				"The President has finally managed to increase the military spending, and has begun tackling the manpower issue. This comes through promoting the recruitment of women in the army, but that requires some political compromises...",
				...
				"This mission happened almost a full month before the last one. Exasperated that it has been a long time where he has dealt no finishing blow to the Svelgers, General Pykot's impatience grew and grew. And the shewd old Gustav knew to play this to his advantage. Pykot is about to bite into a trap. Hook, line and sinker",
				"Battered and bruised is Bernard's army which after the withdrawal of the second Transkal landing force, is the last army on the continent itself. The Whites give relentless assault but Bernard fights on valiantly even with the odds heavily stacked against him. How long can he hold on like this?"
		...
		[//Elamite Empire
			[//Chapter 1
			"The frontline between Elam and Somertin is long and the men must be stretched thin to cover it. Worse still, we will have to cross over defensible barriers such as the great Shahar River or the Khandahar Mountains to advance. If the attack is to succeed, the first and most shocking offensive must take place over the Khandahar Mountains by the most experienced general, otherwise the advance will not be possible at all. Grand Vizier Mutasarif shall lead a diversion over the Mica River, to create an illusion.",
			"Mutasarif's crossing of the Mica was a trick on General Laszlo, one that he bit hook, line and sinker. Now that the anvil is ready, Esfahani will be the hammer.",
			"With the success of Ibrahim Esfahani's push, the enemy has had to weaken their forces from the Shahar segment. Perfect for Ali, who has to capture at least fourteen bridgeheads over this long segment.",
			"By the time Ali started crossing the river, Hassan was already commencing a double operation. He would cross the river, while at the same time sending the marines from behind. ",
			"A punch from Elam and one from the Kargi have staggered Laszlo and his Eight Army. They now stand alone and surrounded. Everything is going according to keikaku.The Sultan wants them eliminated, to show that the Empire is capable of bewegungskrieg just like the Kargi. Translator's note: 'keikaku' means plan"
				],
			[//Chapter 2
				"Laszlo had escaped the encirclement. Although it may be too late, Mutasarif wants to try one final time to capture him and prevent him from being a thorn in the side later on",
				"Due to a desire to at best force Transkalite capitulation or at worst delay them from reinforcing Somertin, we had decided to launch an amphibious assault into Jylla. Ostentively also to earn some esteem for Elam as a navally-capable regional power.",
				"With the Mica sector closed and Mutasarif moving eastwards, Esfahani leads his own push to make common front with the kargits and shorten the outrageously long frontline",
				"Odenshagen is in sight, and although Krystof has lost many men Shmelev is soon coming to his aid. With his limited forces, Hassan must take the jyllan polis before the momentum swings against him. Time is of the essence",
				"Krystof did manage to fortify the polis, but the way from it to the port is a frozen rivulet that couldn't be secured as thoroughly. Precisely where Shmelev and the reconsolidated Krystof want to hit and leave Hassan stranded and without supplies, in grave danger of losing his good-quality troops and their materiel"

				],
			[//Chapter 3
				"In the past few months, Laszlo and Argeseanu's salient had rebecome active, pushing back the Kargit south front. They now stand 200Km away from the Mica River and Esfahani had to move his forces back there in order to solidify the defense of the mountain line. The detachment sent ahead on recon have unfortunately stumbled upon the Somertin vanguard. Esfahani orders the outnumbered recon units to delay the enemy's advance so he can dig in and defend the mountain line",
				"Esfahani's decision to fortify the passes had turned out to be wise. The enemy has indeed come to storm their position. They have superiority in air and armor but Ibrahim believes that with the help of local militias and well-placed AMPAC's, they can hold them back. He is, however, worried as to what this means for the future.",
				"Battered, frozen and demoralized, the contingent of troops that Hassan landed in Jylla found itself overwhelmed. With their objective long past accomplished, Hassan felt that it was time to bring them back home.",
				"It was expected of the south flotillas of the Transkalite Navy to be green water ships; that meaning ships with short range of action. Worse still, no one in the world thought it possible to sail the northern flotillas through the Kolguyev Pass to bring them to the southern naval theater. Hassan's navy, docked in Makka for refueling and repair, is thus up for one nasty surprise.",
				"With Somertin's offensive against Kandahar's passes stopped heroically by Esfahani's heroic struggle, the Sultan saw fit to turn to diplomacy with Somertin's theater commander, General Laszlo. Unknowing to him, their position was way weaker than they thought..."
