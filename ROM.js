ROM={
	...
	StartButtonTexts:["Pentru patrie, credință și popor!",
		"Panzer Vorwarts!",
	...
	UnitNames:["Șantier",
		"Infanterie Ușoară","Infanterie","Infanterie de Asalt","Pușcași Transkaliți","Pușcași Marini Polazieni","Bombardieri","Trupe Speciale de Desant","Stindard de Gărzi Albe","Bombardieri Sinucigași","Stindard de Paladini Albi",
		"Cavalerie","Infanterie Motorizată","Convoi Logistic","Tanc Antiaerian","Batalion de Tancuri Crab","PADAC","Mașină militar-industrială Trosky","TBI Sisu","Boing SH-11 Pulicopter","AYIN",
		"Batalion de Tancuri Caradașcă","Batalion de Tancuri Fulger","Batalion de Tancuri Asekara","Batalion de Tancuri Gorliț","Blindat Vânator de Tancuri","Batalion CBAMP","Batalion de Panțere Koșchei","Batalion de Tancuri Imperterritus","Batalion de Panțere Entwicklung","Batalion CBG Roland ModIII",
		"Baterie de Artilerie","Artilerie Antiaeriană","Artilerie Anti-Tanc","Baterie Moldană","BAAP","Tanc cu Rachete","Baterie de Artilerie 'Berta Grasa'","Pula PDRBDS","BRAT Tugarin","Bateria de Foc și Pucioasă",
		"Flotilă de Transport 'Bărzoiul'","Elicopter Medical 'Pelican'","Escadron Avioane de Vânătoare","Escadron Avioane de Asalt 'Vulturul'","Escadron Bombardiere 'Condor'","Escadron Torpiloare 'Akontio'","Escadron Special 'Zeus'","Superbombardier Solovey","AVN-1 Stihie","ALEF",
		"Barje de Transport","Intrepid", "Submersibil", "Distrugător", "Crucișător Ușor","Crucișător Greu","Cuirasat","Portavion","Supercuirasat","Superportavion", 
		"Baricadă","Buncăr","Turn Defensiv","Turn Antiaerian","Artilerie de Coastă","Atelier","Siloz de Rachete","Bastion","Centru Logistic","Fortăreață"],
	UnitDesc:["Aici se construiesc fortificații ad-hoc",
		"Echipați cu Mosin-Nagantu' lu' străbunicu' și rații expirate, băieții ăștia sunt ieftini rău.",
		"Scheletul oricărei armate. Fiabili, versatili și cel mai important, ieftini.",
		"Bine echipați, bine antrenați, gata sa primească ordine",
		"Crescuți in taigaua transkalită, obișnuiți sa vâneze ca să supraviețuiască. Experți la tir-precizie",
		"Antrenați sa captureze plaje și bancuri riverine fulgerător, puscașii marini luptă în apă ca și pe uscat",
		"Veterani ai Raboiului din Akkadia, bine antrenați și echipați cu arme de distanță.",
		"Specialiști in infiltrarea liniilor dușmane si sabotarea infrastructurii.",
		"Formați prin antrenamente brutale și educați in spirit de sacrificiu suprem, sunt pregătiți să moară pentru Cristos.",
		"Își dau viața de-a dreptul ca să distrugă tancurile dușmane. O măsură disperată dar eficientă",
		"Cei mai buni din cei mai buni devin Paladini, supersoldați cu eficiență, vitejie și armament de neîntrecut",
		
		"Mileniile nu au văzut umila cavalerie să rămână fără rost pe câmpul de luptă",
		"Mai rapizi decât infanteria normală, pot acapara puncte strategice repede și eficient.",
		"Pulifricii laudă tancul cel mai mare iar amatorii tancul cel mai fiabil, dar experții laudă camionul logistic.",
		"În speranța că va preveni dușmanul din a căpăta supremație aeriană, duduind avioane cu rafale de flak.",
		"Vehicul etanș capabil să treacă cu ușurință râuri și să lupte și în apă.",
		"În general această armă e ținută sub lacăt și cheie. Când e dezlănțuită, provoaca orori pe câmpul de luptă.",
		"O minune inginerească, poate produce unități noi in mijlocul câmpului de bătălie",
		"Un vehicul de luptă robust și versatil, capabil să lupte eficient și în teren foarte dificil",
		"Supracompensând lipsa de unități terestre competente cu un elicopter de asalt eficient și versatil",
		"Armă foarte controversată. Propulsând un jet de neutroni, iradiază droaie de dușmani deodată.",
		

		"Un drac de gândac, poate fi fabricat în masă și va umple dușmanul de draci. Și de gândaci",
		"Tanc rapid și versatil dar fragil; perfect pentru blițcrig.",
		"Standardizat până în gaura curului, Asekara e echilibrul perfect între cost și eficiență",
		"Tanc decent, dar arhaic. Blindatele de azi îl lasă în urmă ca performanță",
		"Conceput să poată lovi tancurile dușmane fără să suporte ripostă",
		"Elamiții au creat tancul-vânător perfect, care lovește ca o fantomă orice alt blindat",
		"Perfecțiunea întruchipată în nișa tancurilor breșoare, Coșcheiul poate păstra inițiativa tactică multă vreme",
		"Teroarea unităților terestre, Imperterritus e aproape invulnerabil și îți rupe gaura curului",
		"Construiește peste avantajele lui Koschei și îi netezește neajunsurile",
		"Combinând tăria unui Imperterritus și versatilitatea unui Koschei pentru a creea tancul suprem",
		
		"Artileria e regina războiului",
		"Baterie compatibilă și cu obuze HE și cu AA. Foarte versatilă",
		"Artilerie înalt-penetrantă gândită să penetreze blindate",
		"Scoate un vuiet înfiorător când trage. Teroarea infanteriei",
		"Mecanizat scump și nu prea merită investiția decât in anumite cazuri.",
		"In epoca aia nebună, țările astartiene montau lansatoare de rachete pe orice vehicul le putea duce",
		"Obuzele pantagruelice ale Bertei cele Grase tună in liniștea taigalei",
		"Scopul armatei e să demonstreze cine are pula mai mare. Acest dildău zburător va face fix asta.",
		"Sistem specializat în a folosi rachete balistice să terorizeze avioane și blindate",
		"Artilerie termobarică inovativă, capabilă să dezlănțuie foc și pucioasă asupra dușmanului",
		
		
		"Avioane de transport fragile, dar transportă unitățile rapid și indiferent de teren.",
		"Avem o singură misie. Să ducem băieți proaspeți, și să recuperăm bărbați infirmi",
		"Rapid și furios, rupe alte avioane.",
		"Creat cu scopul exclusiv de a-și băga pula-n unitățile terestre.",
		"Un alt bombardier, dar măcar unul util.",
		"Fute navele mai ceva decat jucătorii de Azur Lane.",
		"Avion de înaltă tehnologie, mai performant decât oricare altul atât în ștraf cât și la bombardament.",
		"Bombardier încet și greoi care ruinează infrastructura și fortificațiile",
		"Avion de vânătoare inovativ; rupe si sparge totul cu arme moderne în timp ce păstrează o prezență radar minimală",
		"Arma supremă; pe cât de distructivă tot atât de îmfiorătoare. Va schimba în veci fața războiului",

		"Barjă de transport, durabilă dar nu excepțional de rapidă.",
		"Transportă echipaje capabile să captureze proprietăți din largul mării cum ar fi sondele petroliere.",
		"Contrar stereotipului, nu sunt eficiente impotriva navelor capitale ci a navelor de transport.",
		"Navă ieftină, rapidă și versatilă",
		"Cea mai multifuncțională ambarcațiune, excelentă în multe roluri.",
		"Cu tunuri mari și baterii auxiliare la discreție, este excelentă pentru a vâna nave sau a bombarda țărmuri.",
		"Cele mai mari tunuri, cel mai greu blindaj si cel mai avansat SCF. O navă cu care patria se poate mândri.",
		"Regele mărilor și oceanelor, devastează orice navă cu valuri de bombe și torpile.",
		"Peste 50.000 de tone de oțel și cele mai puternice tunuri construite vreodată",
		"Monștri colosali de oțel, scumpi dar indestructibili. Unul de-ăsta e destul să distrugă o flotă intreagă",

		"Fortificații ieftine și rapid de ridicat, capabile să țină dușmanul departe.",
		"Forturi cu mitraliere și mortiere, pentru a opri avansul infanteriei inamice.",
		"Fortificație cu varii tipuri de artilerie, capabilă să lovească aproape orice țintă.",
		"Un monstru de beton armat cu o sumedenie de tunuri antiaeriene.",
		"Monstru de beton armat cu tunuri de calibru gigantic, capabile sa distrugă nave de război.",
		"Instalție industrială temporară care generează resurse pentru tine",
		"Instalație defensivă versatilă, capabilă să respingă un val de invadatori",
		"Fortificație statică capabilă să incaseze bombe și obuze și să persiste",
		"Depozitează alimente, muniții, arme și toate proviziile de care unitățile tale ar avea nevoie",
		"O citadelă formidabilă capabilă să oprească în loc o armată de una singură"],
	TraitName:[
		"",
	...
	ClassTraitDesc:[
		"",
		"Primește 50% mai multe pagube de la Arme Ușoare si 50% mai puține de la Arme Grele","Primește aceleași pagube indiferent de arma dușmanului","Primește 50% mai puține pagube de la Arme Ușoare si 50% mai multe de la Arme Grele",
		"Provoacă 50% mai multe pagube unităților Ușoare si 50% mai puține unităților Grele","Provoacă aceleași pagube indiferent de blindajul dușmanului","Provoacă 50% mai puține pagube unităților Ușoare si 50% mai multe unităților Grele","Această unitate nu provoacă pagube",
		"Această unitate nu se mișcă","Foarte versatil dar încet","Rapid dar nu parcurge ușor terenul accidentat","Un echilibru între viteză și versatilitate","Foarte rapid și trece peste orice formă de teren","Se poate deplasa doar în apă","Se poate deplasa doar în apă adâncă","Poate lupta și pe sol, și să treacă rîuri."
		],
	...
	MissionName:[
				[["Manevre de Întârziere","Apără Trecătorile","Plesnind Polazienii","Ultima Redută a lui Vladov","Operațiunea INVINCIBIL"],
					...
					["Rechini de Oțel","Căderea Insulei Valeria","Casație","Amurgul Alb","Operațiunea OȚEL-ARGINTIU"],
					["Operațiunea Țepeș","","","","Operation ICONOCLAST"],
					["","","","","Operation KATAPHRAKTOS"],
					["","","","","Operation GOTTDAMMERUNG"],
					["","","","","Operation TWINSTEEL"]],
				[["Operatsiya 'Salt'","Operatsiya 'Topor'","Operatsiya 'Pumnuire Anală'","Marele Clește","Asediul Patnei"],
					["Jaful Patnei","Ajutorul lui Bela","Șef Implicat","Salient spre Kaula","Bătălia din Kaula"],
					["Operatsiya 'Trident'","Violul din Kaula","Planul Militar 'Tugarin'","Planul Militar 'Solovey'","Voyenyy Plan 'COLOSUL'"],
					[],
					[],
					[],
					[]],
				[["Spatele nostru, expus","Dușmanii noștri, belicoși","Numele nostru, spurcat","Faima noastră, rușinată","Gardă!"],
					["Confruntarea Retardaților","Ungând Palme","Hârb contra Oală Spartă","Iar cântul nostru se va auzi","Până la Kaula și mai departe"],
					["Prințul","Zborul lui Mihai","Camarila Reginală","Alea Iacta Est","Lovitura de Stat"],
					[],
					[]],
				[["Operațiunea Futai Surpriză","Aterizare","Scutul Libertății","Ahh, Petrol","Să terminăm cu asta"],
					["Operațiunea Cabană","'Nam-ul Congelat","Ce e un nazist? O grămadă jegoasă de rasism și agresiune","În numele creșterii economice, consumați!","Pentru oameni!"],
					["La revedere cer albastru!","O femeie puternică ar rezolva treaba","Înfometați după pâine și speranțâ","Tet","Iar soldații vor sparge rangurile"],
					[],
					[]],
				[["Diversiune","Asaltând Trecătorile","Marea Ofensivă a lui Ali","Pumnii lui Hassan","Ghilotină"],
					["Fugărind Fum","Invazia Jyllei","Vantajul","Căderea Odenshagei","Înghețând pentru nimic"],
					["Chestiune de bun-simț","Piază Rea","Retragere Dizgrațioasă","Oală Spartă contr Hârb","Furtună la Orizont"],
					[],
					[]],
				[["","","","",""],["","","","",""]],
				[["","","","",""],["","","","",""]],
